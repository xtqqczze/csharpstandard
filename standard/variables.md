...
- The definite assignment state of a parameter is the same as for a parameter of a named method ([§10.2.6](variables.md#1026-reference-parameters), [§10.2.7](variables.md#1027-output-parameters)).
